...
import { LocalPathToolbar } from "@/components/voies-locales/list/LocalPathsToolbar";
...
const PLUGIN_ID = "voies-locales";

export default async function VoiesLocalesLayout({
  children,
}: {
  children: ReactNode;
}) {
